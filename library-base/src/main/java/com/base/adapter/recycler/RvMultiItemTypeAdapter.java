package com.base.adapter.recycler;
...
public class RvMultiItemTypeAdapter<T> extends RecyclerView.Adapter<RvViewHolder> {
    ...
    public RvMultiItemTypeAdapter addItemViewDelegate(ItemViewDelegate<T> itemViewDelegate) {
        mItemViewDelegateManager.addDelegate(itemViewDelegate);
        return this;
    }

    public RvMultiItemTypeAdapter addItemViewDelegate(int viewType, ItemViewDelegate<T> itemViewDelegate) {
