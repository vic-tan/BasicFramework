...
import com.tanlifei.support.view.dialog.base.dialog.BaseDialog;
...
public class NormalListDialog extends BaseDialog<NormalListDialog> {
    ...
    public View onCreateView() {
        View ll_container = InflaterUtils.inflate(mContext,R.layout.common_dialog_normal_list);
        /** title */
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View llItem = InflaterUtils.inflate(mContext,R.layout.common_dialog_normal_list_item);
