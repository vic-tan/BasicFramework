...
public class ActionBarView extends AutoFrameLayout {
    ...
    private TextView actionbar_opt_right_icon;
    private TextView actionbar_opt_left_icon;
    ...
    public void initView() {
        ...
        actionbar_back_layout.setOnClickListener(new OnClickListener() {
            @Override
        ...
        actionbar_opt_left_text.setTextSize(TypedValue.COMPLEX_UNIT_PX,mBarView.opt_left_textColor);
