...
import com.tanlifei.support.widget.dialog.internal.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public View onCreateView() {
        mLlContainer = (AutoLinearLayout) InflaterUtils.inflate(mContext, R.layout.common_dialog_normal);
        /** title */
