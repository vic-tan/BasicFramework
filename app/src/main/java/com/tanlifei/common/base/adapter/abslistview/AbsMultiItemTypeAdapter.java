...
public class AbsMultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    public AbsMultiItemTypeAdapter(Context context, List<T> datas) {
        this.mContext = context;
        this.mDatas = datas;
        mItemViewDelegateManager = new ItemViewDelegateManager();
    }

    public AbsMultiItemTypeAdapter addItemViewDelegate(ItemViewDelegate<T> itemViewDelegate) {
    ...
    protected void convert(AbsViewHolder viewHolder, T item, int position) {
        mItemViewDelegateManager.convert(viewHolder, item, position);
    }

    public void onViewHolderCreated(AbsViewHolder holder , View itemView )
    {}
