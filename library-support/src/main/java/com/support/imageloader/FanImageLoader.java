...
import com.support.imageloader.core.cache.CustomDiskCache;
import com.support.imageloader.core.display.BlurBitmapDisplayer;
import com.support.imageloader.core.display.BlurFadeInBitmapDisplayer;
import com.support.imageloader.core.display.CircleBitmapDisplayer;
import com.support.imageloader.core.display.CircleBlurBitmapDisplayer;
import com.support.imageloader.core.display.CircleFadeInBitmapDisplayer;
import com.support.imageloader.core.display.CircleRingBitmapDisplayer;
import com.support.imageloader.core.display.RoundedBitmapDisplayer;
import com.support.imageloader.core.display.RoundedBlurBitmapDisplayer;
import com.support.imageloader.core.display.RoundedFadeInBitmapDisplayer;
import com.support.imageloader.core.display.RoundedLomoBitmapDisplayer;
import com.support.imageloader.core.display.RoundedLomoBlurBitmapDisplayer;
import com.support.imageloader.core.display.RoundedLomoFadeInBitmapDisplayer;
import com.support.imageloader.core.imageaware.ImageSwitcherAware;
import com.support.imageloader.core.imageaware.SimpleViewAware;
import com.support.imageloader.core.util.NameGeneratorUtil;
import com.support.imageloader.internal.cache.disc.DiskCache;
import com.support.imageloader.internal.cache.disc.impl.UnlimitedDiskCache;
import com.support.imageloader.internal.cache.memory.MemoryCache;
import com.support.imageloader.internal.cache.memory.impl.LruMemoryCache;
import com.support.imageloader.internal.core.DisplayImageOptions;
import com.support.imageloader.internal.core.ImageLoader;
import com.support.imageloader.internal.core.ImageLoaderConfiguration;
import com.support.imageloader.internal.core.assist.FailReason;
import com.support.imageloader.internal.core.assist.ImageScaleType;
import com.support.imageloader.internal.core.assist.ImageSize;
import com.support.imageloader.internal.core.assist.QueueProcessingType;
import com.support.imageloader.internal.core.decode.BaseImageDecoder;
import com.support.imageloader.internal.core.display.FadeInBitmapDisplayer;
import com.support.imageloader.internal.core.display.SimpleBitmapDisplayer;
import com.support.imageloader.internal.core.download.BaseImageDownloader;
import com.support.imageloader.internal.core.imageaware.ImageAware;
import com.support.imageloader.internal.core.imageaware.ImageViewAware;
import com.support.imageloader.internal.core.listener.ImageLoadingListener;
import com.support.imageloader.internal.core.listener.ImageLoadingProgressListener;
import com.support.imageloader.internal.utils.ImageSizeUtils;
import com.support.imageloader.internal.utils.L;
import com.support.imageloader.internal.utils.StorageUtils;
import com.support.imageloader.view.FanImageView;
...
public class FanImageLoader {
    ...
    public static class Builder {
        ...
        public Builder setShowSize(int width, int height) {
        ...
        public void load() {
            ...
            FanImageLoader.load(this.mUrl, this.mImageSize, this.build(), this.mImageLoadingListener,
        ...
        public void into(View view) {
            if (null != view) {
                ...
                if (view instanceof ImageView) {
                    ...
                    if (mShowWidth > 0 && mShowHeight > 0) {
                        imageView.setMaxHeight(mShowHeight);
                        imageView.setMaxWidth(mShowWidth);
                    }
                ...
                } else if (view instanceof FanImageView) {
                    FanImageView imageSwitcher = (FanImageView) view;
                    if (mShowWidth > 0 && mShowHeight > 0) {
                        imageSwitcher.setShowHeight(mShowHeight);
                        imageSwitcher.setShowWidth(mShowWidth);
                    }
                    if (mDefaultDrawable != null) {
                        ...
                        imageSwitcher.setImageDrawable(new ColorDrawable(0x00000000));
                    }
                }
            }
            FanImageLoader.display(this.mUrl, view, this.build(),
