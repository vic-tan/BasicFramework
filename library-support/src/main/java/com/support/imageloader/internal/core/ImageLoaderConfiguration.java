 ...
 *******************************************************************************/
package com.support.imageloader.internal.core;
...
import com.support.imageloader.internal.cache.disc.naming.FileNameGenerator;
import com.support.imageloader.internal.cache.memory.MemoryCache;
import com.support.imageloader.internal.cache.memory.impl.FuzzyKeyMemoryCache;
import com.support.imageloader.internal.core.assist.FlushedInputStream;
...
import com.support.imageloader.internal.core.decode.ImageDecoder;
import com.support.imageloader.internal.core.download.ImageDownloader;
import com.support.imageloader.internal.core.process.BitmapProcessor;
import com.support.imageloader.internal.utils.L;
import com.support.imageloader.internal.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
     ...
     * <li>diskCache = {@link com.support.imageloader.internal.cache.disc.impl.UnlimitedDiskCache}</li>
    ...
    public static class Builder {
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheExtraOptions(int, int, com.support.imageloader.internal.core.process.BitmapProcessor)}
         * instead
         */
        @Deprecated
         ...
         * {@link com.support.imageloader.internal.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
         ...
         * Default value - {@link com.support.imageloader.internal.cache.memory.impl.LruMemoryCache LruMemoryCache}
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.support.imageloader.internal.cache.disc.impl.ext.LruDiskCache LruDiskCache}
        ...
        /**
         * @deprecated Use {@link #diskCache(com.support.imageloader.internal.cache.disc.DiskCache)}
         */
        @Deprecated
         ...
         * Default value - {@link com.support.imageloader.internal.cache.disc.impl.UnlimitedDiskCache
         * UnlimitedDiskCache}. Cache directory is defined by
         * {@link com.support.imageloader.internal.utils.StorageUtils#getCacheDirectory(Context)
         ...
         * Default value -
         * {@link com.support.imageloader.internal.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link com.support.imageloader.internal.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Consider {@link com.support.imageloader.internal.utils.L#disableLogging()} to disable
     ...
     * using {@link com.support.imageloader.internal.core.assist.FlushedInputStream}.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
